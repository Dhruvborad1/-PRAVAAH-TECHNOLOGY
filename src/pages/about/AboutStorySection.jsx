      ...
      <div className="container mx-auto px-5 md:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <ScrollReveal variant="slide" className="relative">
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-3xl -z-10 transform -rotate-3"></div>
            
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-100 bg-slate-50 aspect-[4/5] sm:aspect-[4/3] lg:aspect-[4/5]">
              {/* IMAGE PLACEHOLDER: 
                  Technology workspace / editorial-style company image. 
                  Recommended ratio: 4:5 or 4:3. 
                  Should feel natural, modern, and clean. 
              */}
              <img 
                src={AboutStoryImg} 
