  ...
  return (
    <section className="relative bg-white py-24 md:py-32 overflow-hidden border-t border-slate-100">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Faster Flowing Lines (Speed Increased) */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal variant="lift" delay={0.1}>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-slate-900 leading-[1.1] tracking-tight mb-8">
              Let's Build What Moves Your Business <span className="pravaah-gradient-text">Forward.</span>
            </h2>
          </ScrollReveal>

          <ScrollReveal variant="lift" delay={0.2}>
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-12 max-w-2xl mx-auto">
              Have an idea, a challenge or a product in mind? Let's turn it into something meaningful.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="lift" delay={0.3}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <Link to="/services" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border border-slate-200 text-slate-900 rounded-full font-semibold transition-all hover:bg-slate-50 hover:border-slate-300 hover:shadow-xs w-full sm:w-auto">
