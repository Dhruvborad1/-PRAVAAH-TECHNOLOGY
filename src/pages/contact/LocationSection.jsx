...
const LocationSection = () => {
  // Target location link provided for direct redirection
  const directMapsUrl = "https://maps.app.goo.gl/xhQdJpPGNhaDX88V9";

  // High-accuracy embedded map destination query
  const mapEmbedUrl = "https://maps.google.com/maps?q=Amina%20Nagar%2C%20Padri%20Bazar%2C%20Gorakhpur%2C%20Uttar%20Pradesh%20273014&t=&z=16&ie=UTF8&iwloc=B&output=embed";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        />
        {/* Soft Ambient Radial Blur Elements */}
              ...
              <div className="p-6 sm:p-8 rounded-[24px] sm:rounded-[30px] border border-blue-100/90 bg-white/90 backdrop-blur-xl shadow-lg shadow-blue-900/5 space-y-6">
                ...
                <div>
                  <h3 className="font-display font-bold text-xl sm:text-2xl text-slate-950 tracking-tight leading-snug">
                    Amorina Market, Surat, <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00D2FF] via-[#2F54EB] to-[#9B51E0]">
                      Gujarat — 395011
                    </span>
                  </h3>
                  <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                    Surat, Gujarat, India. Open for scheduled on-premise architecture discussions, stakeholder meetings, and remote global engineering operations.
                  </p>
                </div>

                {/* Visiting Protocols Information */}
                ...
                {/* Direct Google Maps Navigation Button Using Updated Custom Link */}
                <div className="pt-2">
                  <a
                    href={directMapsUrl}
                    target="_blank"
          ...
          <div className="lg:col-span-7">
            <ScrollReveal variant="blur" delay={0.1}>
              <div className="relative h-full min-h-[380px] lg:min-h-[500px] rounded-[24px] sm:rounded-[30px] border border-blue-100/90 bg-white/90 p-2 sm:p-2.5 backdrop-blur-xl shadow-lg shadow-blue-900/5 overflow-hidden group">
                ...
                {/* Embedded Live Google Map with Direct Target Pin */}
                <div className="relative w-full h-full min-h-[360px] lg:min-h-[480px] rounded-[18px] sm:rounded-[22px] overflow-hidden bg-slate-100 border border-slate-200/80">
                  <iframe
                    title="Pravaah Technologies Headquarters Location Map"
                    src={mapEmbedUrl}
                  ...
                  {/* Micro Map Interactive Overlay Tip */}
                  <div className="absolute bottom-3.5 right-3.5 z-20 pointer-events-none hidden sm:block">
                    <a
                      href={directMapsUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="pointer-events-auto inline-flex items-center gap-1.5 rounded-lg border border-blue-100 bg-white/95 backdrop-blur-md px-2.5 py-1 text-[10px] font-mono text-slate-600 shadow-xs hover:text-blue-600 transition-colors"
                    >
